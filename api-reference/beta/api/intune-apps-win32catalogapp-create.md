---
title: "Create win32CatalogApp"
description: "Create a new win32CatalogApp object."
author: "jaiprakashmb"
...
Create a new [win32CatalogApp](../resources/intune-apps-win32catalogapp.md) object.
...
## Request body
In the request body, supply a JSON representation for the win32CatalogApp object.

The following table shows the properties that are required when you create the win32CatalogApp.
...
## Response
If successful, this method returns a `201 Created` response code and a [win32CatalogApp](../resources/intune-apps-win32catalogapp.md) object in the response body.
