---
title: "Update win32CatalogApp"
description: "Update the properties of a win32CatalogApp object."
author: "jaiprakashmb"
...
Update the properties of a [win32CatalogApp](../resources/intune-apps-win32catalogapp.md) object.
...
## Request body
In the request body, supply a JSON representation for the [win32CatalogApp](../resources/intune-apps-win32catalogapp.md) object.

The following table shows the properties that are required when you create the [win32CatalogApp](../resources/intune-apps-win32catalogapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [win32CatalogApp](../resources/intune-apps-win32catalogapp.md) object in the response body.
...

{
  ...
  "mobileAppCatalogPackageId": "Mobile App Catalog Package Id value"
}
```
...
{
  "@odata.type": "#microsoft.graph.win32CatalogApp",
  "id": "47b7a0ca-a0ca-47b7-caa0-b747caa0b747",
  "displayName": "Display Name value",
  "description": "Description value",
  "publisher": "Publisher value",
  "largeIcon": {
