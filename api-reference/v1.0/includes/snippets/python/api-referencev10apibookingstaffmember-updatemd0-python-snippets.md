...
result = await client.solutions.booking_businesses.by_booking_businesse_id('bookingBusiness-id').staff_members.by_staff_member_id('bookingStaffMemberBase-id').patch(request_body = request_body)
